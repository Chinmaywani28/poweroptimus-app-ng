...
@Component({
    selector: 'app-advance-line-chart',
    standalone: true,
    imports: [],
    templateUrl: './advance-line-chart.component.html',
    styleUrl: './advance-line-chart.component.css',
})
export class AdvanceLineChartComponent {
